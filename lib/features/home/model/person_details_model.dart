...
class PersonDetailsResponseModel {
  ...
  factory PersonDetailsResponseModel.fromRawJson(String str) => PersonDetailsResponseModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory PersonDetailsResponseModel.fromJson(Map<String, dynamic> json) => PersonDetailsResponseModel(
